		...
		else
		{
			...
			if(dboutput($row["Password"]) == encrypt($Password))
			{
				...
				if($_SESSION["RoleID"] == 1)
					redirect("admin/dashboard.php");
				else if($_SESSION["RoleID"] == 2 && $_SESSION["Admin"] == 1)
					redirect("admin/dashboard.php");
				else if($_SESSION["RoleID"] == 2 && $_SESSION["Admin"] == 0)
					redirect("faculty/dashboard.php");
            ...
            <div id="wrapper">
                <div id="login" class="animate form">
                    <section class="login_content">
                      ...
                      <?php    echo $msg; if(isset($_SESSION["msg"])) { echo $_SESSION["msg"]; $_SESSION["msg"] = ""; } ?>
                            <div class= "row">
                                ...
                                <div class ="col-lg-12 col-xs-12  ">
                                    ...
                                    <input name="Username" type="text" class="form-control has-feedback-left"  placeholder="Useranme" >
                                ...
                                <div class ="col-lg-12 col-xs-12">
                                    ...
                                    <span class="fa fa-lock form-control-feedback left" aria-hidden="true"></span>
                                     ...
                                     <a href ="forgetpass" >Forget Password ? No worries :) click here</a>
                                       ...
                                       <!--     <div class="g-recaptcha" data-sitekey="6LcN3SkTAAAAALQ6rYkuZrSjKq8E7ZZuF8JPquOS"></div> -->
                                ...
                                <div class ="col-lg-12 col-xs-12">
                                      ...
                                      <div class="g-recaptcha" data-sitekey="6Lep3CkTAAAAAE31w5Z_7qxga5MaCK-oDuUyzqbq" ></div>
                            ...
                            <div>
                                ...
                                <p>&COPY;2016 All Rights Reserved.<br>Sir Syed University of Engineering and Technology Karachi.<br>  </p>                          </div>
                            </div>
                        </form>
                        <!-- form -->
                    </section>
