...
if (isset($_POST["Add-section"]) && $_POST["Add-section"] == "Add-section") {
    ...
    else if(checkavailability('sections', 'Name', $Name) > 0)
	{
		$msg = '<div class="alert alert-danger alert-dismissable">
		<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
		<i class="fa fa-ban"></i>
    ...
    if ($msg == "") {
        $query = "INSERT INTO sections SET DateAdded=NOW(), DateModified=NOW(),
		Name='" . dbinput($Name) . "',
        ...
        redirect("add-section");
    }
}



$query = "SELECT ID, Name,Remarks, Status, DateAdded, DateModified FROM sections WHERE ID<>0";
...
if(isset($_POST["action"]) && $_POST["action"] == "delete")
{
	if(isset($_POST["chkIDs"]) && is_array($_POST["chkIDs"]))
	{
		...
		{
			mysql_query("DELETE FROM sections WHERE ID IN (" . $BID . ")") or die(mysql_error());
		}
		$_SESSION["msg"]='<div class="alert alert-success alert-dismissable">
		<i class="fa fa-check"></i>
		<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
		<b>All selected section(s) deleted.</b>
		</div>';
		redirect("add-section");
	}
	else
	{
		...
		<i class="fa fa-ban"></i>
		<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
		<b>Please select any section to delete.</b>
		</div>';
	}
}
...
if (isset($_SESSION["msg"])) {
    ...
    $_SESSION["msg"] = "";
                            ...
                            <!--- content of panel -->
                            <form id="add-section" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" enctype="multipart/form-data" data-toggle="validator">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class ="col-lg-4">
                                            ...
                                            <input name="Name" type="text" class="form-control" id="Name" placeholder="Enter Section i.e. A" value="<?php echo $Name; ?>" >
                                        ...
                                        <div class="col-lg-4 ">
                                            <label>Remarks:</label>
                                             ...
                                             <input name="Remarks" type="text" class="form-control " id="Remarks" placeholder="i.e. Section-A" value="<?php echo $Remarks; ?>" >
                                               <div class="help-block with-errors"></div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class= "col-lg-12">
                                            ...
                                            <input type="submit" class="btn btn-success pull-right" name="Add-section" value="Add-section" />
                                        </div>
                        ...
                        <div class="x_title">
                            ...
                            <ul class="nav navbar-right panel_toolbox">
                                 ...
                                 <li><button  type="button" class="btn btn-danger btn-sm" id ="delete" onclick="return deleteChecked()" value = "delete">
                                                    <span class="glyphicon glyphicon-trash"></span> &nbsp;Delete Section(s)
                                                </button></li>
                                <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                                </li>
